...
import {Principio} from '../schema/principio';
...
export class PrincipioService {
    ...
    registrarPrincipio(principioBody: Principio): Observable<any> {
    ...
    actualizarPrincipio(principio: Principio): Observable<any> {
    ...
    eliminarPrincipio(principioBodyEliminar: Principio): Observable<any> {
